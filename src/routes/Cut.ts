...
Routes.post('/create',AUTH, Cut_create_validator, Cteate_Cut);

Routes.get('/fetch', Fetch_Cut_validator, fetch_Cut);

Routes.patch('/update',AUTH, Cut_Update_validator, Update_Cut);

Routes.delete('/delete/:cutid',AUTH, Cut_Remove_validator, Remove_Cut);
